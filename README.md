...
> [!IMPORTANT]
> This project has been moved to <https://git.alternerd.tv/Foundry-VTT/custom-group-initiative>

[![Please don't upload to GitHub](https://nogithub.codeberg.page/badge.svg)](https://nogithub.codeberg.page)

[![latest release](https://git.alternerd.tv/Foundry-VTT/custom-group-initiative/badges/release.svg?color=limegreen)](https://git.alternerd.tv/Foundry-VTT/custom-group-initiative/releases/latest)
...
A module for Foundry VTT that allows grouping combatants in initiative by custom rules, or disabling grouping entirely.
